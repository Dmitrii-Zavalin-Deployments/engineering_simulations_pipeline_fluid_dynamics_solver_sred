...
from src.main_solver import run_navier_stokes_simulation  # ✅ Only import what's needed
...
def test_load_reflex_config_valid(tmp_path):
    from src.main_solver import load_reflex_config  # ✅ Localized import
...
def test_run_simulation_triggers_all(monkeypatch, mock_input_file, tmp_path):
    ...
    monkeypatch.setattr("src.main_solver.generate_snapshots", lambda input_data, scenario_name, reflex_config: [(0, dummy_snapshot)])
