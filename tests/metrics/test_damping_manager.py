...
def test_low_variation_no_damping():
    grid = [
        Cell(x=0, y=0, z=0, velocity=[1.0, 0.0, 0.0], pressure=1.0),
        Cell(x=1, y=0, z=0, velocity=[1.1, 0.0, 0.0], pressure=1.0),
        Cell(x=2, y=0, z=0, velocity=[1.2, 0.0, 0.0], pressure=1.0)
    ]
    time_step = 0.1
    assert should_dampen(grid, time_step) is False
...
def test_velocity_with_yz_component():
    grid = [
        ...
        Cell(x=1, y=0, z=0, velocity=[0.0, 0.0, 2.5], pressure=1.0),
        Cell(x=2, y=0, z=0, velocity=[0.0, 0.5, 0.0], pressure=1.0)
    ]
    time_step = 0.1
    assert should_dampen(grid, time_step) is True
...
def test_extreme_spike_vs_average_velocity():
    grid = [
        Cell(x=0, y=0, z=0, velocity=[0.2, 0.0, 0.0], pressure=1.0),
        Cell(x=1, y=0, z=0, velocity=[0.2, 0.0, 0.0], pressure=1.0),
        Cell(x=2, y=0, z=0, velocity=[1.0, 0.0, 0.0], pressure=1.0)
    ]
    time_step = 0.1
    assert should_dampen(grid, time_step) is True
