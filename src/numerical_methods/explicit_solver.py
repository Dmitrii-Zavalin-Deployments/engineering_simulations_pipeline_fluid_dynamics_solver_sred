...
class ExplicitSolver:
    """
    Performs a single explicit time step for incompressible fluid simulation
    ...
    def __init__(self, fluid_properties: dict, mesh_info: dict, dt: float):
        ...
        self.step_counter = 0  # Optional internal step tracking
    ...
    def step(self, velocity_field: np.ndarray, pressure_field: np.ndarray) -> tuple[np.ndarray, np.ndarray]:
        ...
        # --- Step 2: Apply velocity BCs to tentative velocity ---
        ...
        # --- Step 3: Solve Poisson equation for pressure projection ---
        ...
        # --- Step 5: Apply final BCs to corrected fields ---
        ...
        # --- Step 6: Print full diagnostics to stdout (GitHub logs) ---
        self.step_counter += 1
        log_flow_metrics(
            velocity_field=updated_velocity,
            pressure_field=updated_pressure,
